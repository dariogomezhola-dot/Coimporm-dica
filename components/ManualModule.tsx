...
import { ChevronLeft, ChevronRight, Send, ArrowRight, FileText, Download } from 'lucide-react';
...
const ManualModule: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full relative bg-gradient-to-br from-dark-900 to-dark-800 overflow-hidden">
      
      {/* Main Content Area */}
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-8 p-6 lg:p-12 overflow-hidden">
      ...
      <div className="h-16 bg-dark-800 border-t border-dark-700 flex items-center justify-between px-8 relative shrink-0 z-30">
          ...
          <div className="text-sm text-slate-500 font-mono">
              Diapositiva <span className="text-white font-bold">{currentSlideIndex + 1}</span> de {SLIDES.length}
          </div>
